...
import { ArrowDownToLine, ArrowUpFromLine, Activity, TrendingUp, TrendingDown } from "lucide-react";
...
export default function MovementsOverview() {
  ...
  const { data: summary, isLoading } = useMovementsSummary(orgId);
  ...
  return (
    <div className="grid gap-4 md:grid-cols-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Entrées (30 jours)</CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">unités entrées en stock</p>
        </CardContent>
      </Card>

      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Sorties (30 jours)</CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">unités sorties du stock</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">variation nette du stock</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">mouvements ce mois-ci</p>
        </CardContent>
      </Card>
    </div>
  );
