-- Migration: create get_dashboard_tasks RPC
-- Retourne un tableau JSONB de tâches actionnables triées par score décroissant.
...
BEGIN
  ...
  -- CTE 2 — Produits sous le seuil minimum
  below_min AS (
    SELECT
      id,
      name,
